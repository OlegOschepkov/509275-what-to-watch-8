...
const promoMock: Movie = {
  id: 10001,
  name: 'The Grand Budapest Hotel',
  poster: 'img/the-grand-budapest-hotel-poster.jpg',
  bgPoster: 'img/bg-the-grand-budapest-hotel.jpg',
  genre: 'Drama',
  released: 2014,
};
...
const moviesMock : Movies = [
  ...
  },
  {
    ...
    bgPoster: 'img/bohemian-rhapsody.jpg',
    genre: 'Drama',
    released: 2016,
